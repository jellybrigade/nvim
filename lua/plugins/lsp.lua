return {
  ...
  config = function()
    ...
    -- Auto-fix with eslint on save, for js/ts/vue
    vim.api.nvim_create_autocmd('LspAttach', {
    ...
    -- install) so a single ts_ls instance understands .vue files; vue_ls itself only
    -- provides Vue-template-specific features. See:
